...
/**
 * ConfirmBulkDelete Component
 * A confirmation dialog for bulk deleting multiple songs
 * 
 * @param {boolean} isOpen - Whether the popup is visible
 * @param {function} onClose - Function to close the popup
 * @param {function} onConfirm - Function to execute bulk delete action
 * @param {number} count - Number of songs to delete
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-admin-text-tertiary mt-3">
                  This will permanently remove all selected songs from the platform, including all streaming data and user playlists.
                </p>
                <div className="mt-4 p-3 bg-apple-red/10 border border-apple-red/20 rounded-lg">
                  <p className="text-sm text-apple-red font-medium">
                    ⚠️ Warning: You are about to delete {count} song{count > 1 ? 's' : ''} at once. This operation cannot be reversed.
                  </p>
                </div>
              </div>
